								...
								<div
									...
									<div
										...
										<span
											...
											autocapitalize="off"
											class="Input__InnerInput-j7moqy-1 bfmNPl" value="5,000,000">원</span>
									</div>
								</div>
								<div class="style__ProjectEstimatedAmount-sc-1mawbc1-15 qZZRG">
									<div class="style__TotalAmount-sc-1mawbc1-16 OobSQ">
										<span>목표 금액 달성 시 예상 수령액</span> <em>4,560,000원</em>
									</div>
									<div class="style__FeesWrap-sc-1mawbc1-17 jFIOTU">
										총 수수료<em>440,000원</em>
									</div>
									<div class="style__FeesWrap-sc-1mawbc1-17 fsjSoz">
										결제대행 수수료 (총 결제액의 3% + VAT)<em>165,000원</em>
									</div>
									<div class="style__FeesWrap-sc-1mawbc1-17 fsjSoz">
										Basic 요금제 수수료(총 결제 금액의 5% + VAT)<em>275,000원</em>
									</div>
								</div>
							</div>
						</div>
